        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          ...
          <div>
            ...
            <ul class="space-y-3 text-gray-400 text-sm">
              ...
              <li class="flex items-center gap-2">
                <svg class="w-4 h-4 text-edm-orange-400 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"/></svg>
                +57 300 000 0000
              </li>
              <li class="flex items-center gap-2">
...
export class FooterComponent {
  readonly socials = [
    {
      name: 'Instagram',
      url: 'https://instagram.com/fantribute',
    ...
    {
      name: 'Twitter/X',
      url: 'https://twitter.com/fantribute',
    ...
    {
      name: 'YouTube',
      url: 'https://youtube.com/@fantribute',
  ...
  readonly footerLinks = [
    ...
    },
    {
      ...
      links: [
        ...
        { label: 'Mis Tickets', path: '/perfil' },
      ],
    },
  ];

  readonly paymentMethods = ['PSE', 'Nequi', 'Daviplata', 'Visa', 'Mastercard', 'PayPal', 'Stripe'];
}
